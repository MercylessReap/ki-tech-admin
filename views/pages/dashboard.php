...
<div class="container-fluid">
  ...
  <div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
      <h3 class="text-themecolor">Dashbord</h3>
      <ol class="breadcrumb">
  ...
  <div class="row">
    <!-- Column -->
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4">
                      <div class="card">
                          <img class="" src="./material-pro/assets/images/background/weatherbg.jpg" alt="Card image cap">
                          ...
                          <div class="card-body">
                              <div class="message-box contact-box">
                                  ...
                                  <div class="message-widget contact-widget">
                                      <!-- Message -->
                                      <a href="#">
                                          <div class="user-img"> <img src="./material-pro/assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                          <div class="mail-contnet">
                                              <h5>Pavan kumar</h5> <span class="mail-desc">info@wrappixel.com</span></div>
                                      </a>
                                      <!-- Message -->
                                      <a href="#">
                                          <div class="user-img"> <img src="./material-pro/assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                          <div class="mail-contnet">
                                      ...
                                      <!-- Message -->
                                      <a href="#">
                                          <div class="user-img"> <img src="./material-pro/assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                          <div class="mail-contnet">
                              ...
                              <div class="tab-pane active" id="home" role="tabpanel">
                                  <div class="card-body">
                                      <div class="profiletimeline">
                                          <div class="sl-item">
                                              <div class="sl-left"> <img src="./material-pro/assets/images/users/1.jpg" alt="user" class="img-circle"> </div>
                                              <div class="sl-right">
                                                  <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                      <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                      <div class="row">
                                                          <div class="col-lg-3 col-md-6 m-b-20"><img src="./material-pro/assets/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                                                          <div class="col-lg-3 col-md-6 m-b-20"><img src="./material-pro/assets/images/big/img2.jpg" alt="user" class="img-responsive radius"></div>
                                                          <div class="col-lg-3 col-md-6 m-b-20"><img src="./material-pro/assets/images/big/img3.jpg" alt="user" class="img-responsive radius"></div>
                                                          <div class="col-lg-3 col-md-6 m-b-20"><img src="./material-pro/assets/images/big/img4.jpg" alt="user" class="img-responsive radius"></div>
                                                      </div>
                                          ...
                                          <hr>
                                          <div class="sl-item">
                                              <div class="sl-left"> <img src="./material-pro/assets/images/users/2.jpg" alt="user" class="img-circle"> </div>
                                              <div class="sl-right">
                                                  <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                      <div class="m-t-20 row">
                                                          <div class="col-md-3 col-xs-12"><img src="./material-pro/assets/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                                          ...
                                          <hr>
                                          <div class="sl-item">
                                              <div class="sl-left"> <img src="./material-pro/assets/images/users/3.jpg" alt="user" class="img-circle"> </div>
                                              <div class="sl-right">
                                                  <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                          ...
                                          <hr>
                                          <div class="sl-item">
                                              <div class="sl-left"> <img src="./material-pro/assets/images/users/4.jpg" alt="user" class="img-circle"> </div>
                                              <div class="sl-right">
                                                  <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
